...
savehistory("/media/shyam/external/multiome_clu_2/multi5/clu_0_2_dpi_smad_tead_ap1_peak_accessibility_analysis.Rhistory")
rm(clu)
gc()
save.image("/media/shyam/external/multiome_clu_2/multi5/clu_0_2_dpi_smad_tead_ap1_peak_accessibility_analysis.RData")
savehistory("/media/shyam/external/multiome_clu_2/multi5/clu_0_2_dpi_smad_tead_ap1_peak_accessibility_analysis.R")
